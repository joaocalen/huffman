...
${OBJECTDIR}/bin.o: bin.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bin.o bin.c

${OBJECTDIR}/codificador.o: codificador.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/codificador.o codificador.c

${OBJECTDIR}/compactador.o: compactador.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/compactador.o compactador.c

${OBJECTDIR}/descompactador.o: descompactador.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/descompactador.o descompactador.c

${OBJECTDIR}/escreveArquivoCompactado.o: escreveArquivoCompactado.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/escreveArquivoCompactado.o escreveArquivoCompactado.c

${OBJECTDIR}/escreveArquivoOriginal.o: escreveArquivoOriginal.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/escreveArquivoOriginal.o escreveArquivoOriginal.c
